...
export default moduleName => {
    const baseModule = {
         ...
         */
        updateStoreAction: item =>
            postRequest(`${moduleName}/${item.id}`, item).then(response => {
                // updateStoreEntry
                return response;
            }),
         ...
         */
        createStoreAction: item =>
            postRequest(moduleName, item).then(response => {
                // createStoreEntry?
                return response;
            }),
        /**
         ...
         */
        readStoreAction: () => getRequest(moduleName),
